...
export default function Home() {
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Hello! I'm an AI Rate My Professor Assistant. How may I assist you today with your courses/professor?",
    },
  ]);
  ...
  const colors = {
    ...
    assistant: "#a29af5", // Assistant messages
    user: "#f5ce9a", // User messages
    text: "#000000", // Font color
    button: "#c0b9c4", // Send button
  };
  ...
  return (
    ...
    >
      ...
      >
        <Box
          sx={{
            backgroundColor: "#c0b9c4", // Solid dark green for header
            borderRadius: "12px",
            padding: "20px",
            marginBottom: "20px",
            textAlign: "center",
